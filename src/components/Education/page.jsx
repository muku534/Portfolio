                    ...
                    <div className="flex flex-wrap -m-4">
                        <div className="p-8 lg:w-full lg:pl-24 md:w-full">
                            <div className="flex sm:flex-row flex-col">
                                ...
                                <div className="flex-grow">
                                    <h2 className="text-indigo-600 text-lg title-font font-bold mb-3">2018</h2>
                        ...
                        <div className=" lg:w-full lg:pl-24 md:w-full">
                            <div className="flex  sm:flex-row flex-col">
                                ...
                                <div className="flex-grow">
                                    <h2 className="text-indigo-600 text-lg title-font font-bold mb-3">2020</h2>
                        ...
                        <div className=" lg:w-full lg:pl-24 md:w-full">
                            <div className="flex sm:flex-row flex-col">
                                ...
                                <div className="flex-grow">
                                    <h2 className="text-indigo-600 text-lg title-font font-bold mb-3">2020-2023</h2>
                                    <h2 className="text-gray-900 text-xl title-font font-bold mb-3">BCA (Bachelor of Computer Applications)</h2>
                                    <p className="leading-relaxed text-base">Blue bottle crucifix vinyl post-ironic four dollar toast vegan taxidermy. Gastropub indxgo juice poutine.</p>
                                    {/* <a className="mt-3 text-indigo-400 inline-flex items-center">Learn More
                                        <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" className="w-4 h-4 ml-2" viewBox="0 0 24 24">
                                            <path d="M5 12h14M12 5l7 7-7 7"></path>
                        ...
                        <div className=" lg:w-full lg:pl-24 md:w-full">
                            <div className="flex sm:flex-row flex-col">
                                ...
                                <div className="flex-grow">
                                    <h2 className="text-indigo-600 text-lg title-font font-bold mb-3">2023 - 2025</h2>
