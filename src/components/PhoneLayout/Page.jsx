...
export default function Phone({ togglePhone }) {
    ...
    return (
        <div className="fixed lg:bottom-0 bottom-20 justify-center items-center right-0 mr-14 lg:mr-5 mb-5 z-50"> {/* Increase z-index to 50 */}
            <div className="relative mx-auto border-gray-800 dark:border-gray-800 bg-gray-800 border-[14px] rounded-[2.5rem] h-[600px] w-[300px] shadow-lg overflow-y-auto scrollbar-hide"> {/* Add shadow-lg for depth */}
                {/* Your phone component UI */}
                ...
                <div className="rounded-[2rem] overflow-hidden w-[272px] h-[572px] bg-white dark:bg-gray-800">
                    ...
                    <form class="max-w-md mx-auto pl-2 pr-2 m-10">
                        ...
                        <div class="flex">
                            <textarea id="message" rows="4" class="block p-2.5 overflow-auto w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Write your thoughts here..."></textarea>
                        </div>
