...
const page = ({ isMobileOrTabletDevice }) => {
    return (
        <footer className={`text-gray-400 bg-gradient-to-r from-indigo-100 to-indigo-100 body-font ${isMobileOrTabletDevice ? 'mb-12' : ''}`}>
            <div className="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
                ...
                <span className="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">
                    ...
                    <Link href={"https://twitter.com/"} className="ml-3 text-gray-400">
                        <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" className="w-5 h-5" viewBox="0 0 24 24">
                            <path d="M23 3a10.9 10.9 0 01-3.14 1.53 4.48 4.48 0 00-7.86 3v1A10.66 10.66 0 013 4s-4 9 5 13a11.64 11.64 0 01-7 2c9 5 20 0 20-11.5a4.5 4.5 0 00-.08-.83A7.72 7.72 0 0023 3z"></path>
                        </svg>
                    </Link>
                    <Link href={"https://github.com/muku534"} className="ml-3 text-gray-400">
                        <svg xmlns="http://www.w3.org/2000/svg" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" className="w-5 h-5" viewBox="0 0 42 42">
                    ...
                    <Link href={"https://www.instagram.com/mr.mukesh_534?igsh=ZXkwN3Btb2o1bDVh"} className="ml-3 text-gray-400">
                        <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" className="w-5 h-5" viewBox="0 0 24 24">
                            <rect width="20" height="20" x="2" y="2" rx="5" ry="5"></rect>
                            <path d="M16 11.37A4 4 0 1112.63 8 4 4 0 0116 11.37zm1.5-4.87h.01"></path>
                        </svg>
                    </Link>
                    <Link href={"https://www.linkedin.com/in/mukesh-prajapati-a6a670235?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"} className="ml-3 text-gray-400">
