        ...
        <nav className={`hidden lg:flex fixed w-full z-20 top-0 left-0 transition-all ${scrolled ? "bg-white shadow-md" : "bg-transparent"
            ...
            <div className="max-w-screen-lg flex flex-wrap lg:ml-32 p-4">
                ...
                >
                    ...
                    <a href="/assets/MukeshPrajapati_Resume.pdf" download="MukeshPrajapati_Resume.pdf" className="ml-4 text-gray-100 bg-gray-900 justify-center inline-flex items-center focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600" role="button">
                        Resume
                    </a>
                </div>
            </div>
