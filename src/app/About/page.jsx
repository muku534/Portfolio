    ...
    return (
        <div id="About">
            <section className="text-gray-400 body-font mt-40 ">
                <div className="container mx-auto flex lg:px-5 mt-5 md:flex-row flex-col items-center justify-center" >
                    ...
                    <div className="lg:flex-grow lg:pl-24  lg:mx-20  md:pt-5 flex flex-col md:text-left items-center text-center items-center justify-center">
                        <div className="mb-4">
                            <h1 className="title-font sm:text-5xl text-3xl mb-1 font-extrabold text-gray-800">About Me
                            </h1>
                            <hr className="w-48 h-1 mx-auto my-2 bg-indigo-300 border-0 rounded md:my-1 dark:bg-indigo-300"></hr>
                        </div>
                        <div className="lg:pl-24 lg:pr-24 md:pl-4 md:pr-4 pt-5">
